      ...
      <div id="g-header" class="ui-helper-clearfix">
        <div id="g-banner">
          ...
          <a id="g-logo" class="g-left" href="<?= item::root()->url() ?>" title="<?= t("go back to the Gallery home")->for_html_attr() ?>">
            <img width="107" height="48" alt="<?= t("Gallery logo: Your photos on your web site")->for_html_attr() ?>" src="/themes/wind/images/logo.png" />
          </a>
          <? endif ?>
          <?= $theme->user_menu() ?>
          <?= $theme->header_top() ?>
...
</script><noscript><p><img src="http://istatistik.linux.org.tr/piwik.php?idsite=7" style="border:0" alt="" /></p></noscript>

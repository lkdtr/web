 ...
 <div id="footer">
  ...
  <div class="block-content">
    ...
    <div class="copyright">
     ...
     <p>
     <a class="rss" href="<?php bloginfo('rss2_url'); ?>"><?php _e('Entries (RSS)','arclite'); ?></a> <?php _e('and','arclite');?> <a href="<?php bloginfo('comments_rss2_url'); ?>"><?php _e('Comments (RSS)','arclite'); ?></a> <br /> <br /> <a href="javascript:void(0);" class="toplink">Yukarı</a>

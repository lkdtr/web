...
<div id="container">
    ...
    <div id="post-one">
        ...
        Üzgünüm,aradığınız sayfa bulunamadı. Lütfen irdiğiniz adresin yazımını kontrol edin.# Sorun yaşamaya devam ediyorsanız lütfen  <a href="<?php echo get_option('home'); ?>/">anasayfa</a>ya geri dönünüz.
        <br clear="all" />
        </div>

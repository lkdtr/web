      ...
      <tbody> 
         <tr> 
          <td valign="top" width="33%"> <table border="0" cellpadding="2" cellspacing="0"> 
              <tbody> 
                <tr> 
                  <td bgcolor="#466176" height="35" width="100%"><font color="white" size="2px"><strong>Yýlýn Penguenleri Aday Gösterme Formu</strong></font></td> 
                </tr> 
                <tr>
 	 	 <td height=2> </td>
                <tr>
                <tr> 
                  <td><center>
                      <table width="100%" cellpadding="2" cellspacing="0" border="0"> 
                       <tr>
                         <td class=uyari><font>Lütfen yeni bir aday göstermeden önce, ilgili dalda önceki yýllarda ödül alanlarý ve bu yýl gösterilen adaylarý "<a href=goster.php?tip=kategori>Ödül Kategorileri</a>" sayfasýndan kontrol etmeyi unutmayýn!</font></td>
                       <tr>
                       <tr>
			 <td height=2> </td>
                       <tr>
                      ...
                      <form name="aday_eklef" action="aday_ekle2.php" method="post"> 
                        <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#FFFFFF"> 
                          <tr bgcolor="#f4f4f4"> 
                            <td valign="top"><font color="#000000"><font size="-1">Aday göstermek istediðiniz kiþi, kurum veya içerik </font>(Daha ayrýntýlý bilgi için lütfen ödül kategorilerine bakýnýz.)</font></td> 
                            <td><font size="-1"> 
                          ...
                          <tr> 
                            <td  valign="top"><font color="#000000"><font size="-1">Öneren e-posta adresi</font>&nbsp;(Lütfen size ulaþabilmemiz için geçerli bir e-posta adresi giriniz.) </font></td> 
                            <td ><font size="-1"> 
                              <input type="text" name="oneren_eposta" size="20" maxlength="150" value=""> 
                              </font>&nbsp;</td> 
                          </tr> 
                          <tr bgcolor="#f4f4f4"> 
                            <td  valign="top"><font color="#000000"><font size="-1">Adayýnýz için açýklayýcý bir metin giriniz, "Neden aday olmalý?" açýklayýnýz. </font></font></td> 
                            <td ><font size="-1"> 

...
<center>                      <form name="yorum_eklef" action="yorum_ekle2.php" method="post"> 
                        <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#FFFFFF"> 
                          <tr bgcolor="#f4f4f4"> 
                            <td valign="top"><font color="#000000"><font size="-1">Hakkında yorum yapacağınız penguen</font></font></td> 
                            <td><font size="-1"> 
                              <input type="hidden" name="penguen" value="<?=$_GET['id']?>"> <?=penguen_adi($_GET['id'])?>
                              </font>&nbsp;</td> 
                          </tr>
                          <tr> 
                            <td  valign="top"><font color="#000000"><font size="-1">Adınız Soyadınız</font>&nbsp;</font></td> 
                            <td ><font size="-1"> 

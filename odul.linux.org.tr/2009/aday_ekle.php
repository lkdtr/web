       ...
       <td height=2> </td>
                      ...
                      <form name="aday_eklef" action="aday_ekle2.php" method="post">
                        <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#FFFFFF">
                          ...
                          <tr>
                            <td><font size="-1">
                              <input type="text" name="aday_adi" size="35" maxlength="100" value="">
                              </font>&nbsp;</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td ><font size="-1">
                              <input type="text" name="oneren_adi" size="35" maxlength="100" value="">
                              </font>&nbsp;</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td ><font size="-1">
                              <input type="text" name="oneren_eposta" size="35" maxlength="150" value="">
                              </font>&nbsp;</td>
                          </tr>
                          <tr bgcolor="#f4f4f4">
                          ...
                          <tr>
                            <td ><font size="-1">
                              <textarea name="oneri_metni" cols="25" rows="20"></textarea>
                              </font>&nbsp;</td>
                          </tr>
                          <tr bgcolor="#f4f4f4">

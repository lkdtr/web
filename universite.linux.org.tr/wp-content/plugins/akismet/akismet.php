...
Description: Akismet, yazýlarýnýza yapýlan yorumlarýn istenmeyen (spam) olup olmadýklarýný kontrol eder. Bu servisi kullanmak için ücretsiz <a href="http://wordpress.com/api-keys/">WordPress.com API anahtarý</a> almanýz gerekmektedir. Akismet'in yakaladýðý spam yorumlarý "Yorumlar" menüsü altýnda inceleyebilirsiniz. Sitenizde Akismet istatistiklerini göstermek istiyorsanýz temanýza <code>&lt;?php akismet_counter(); ?></code> kodunu yerleþtirin. Ayrýca, <a href="http://wordpress.org/extend/plugins/stats/">WP Stats Eklentisi</a>ne de bakabilirsiniz.
Version: 2.2.4

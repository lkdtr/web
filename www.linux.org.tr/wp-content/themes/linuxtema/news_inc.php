...
<div id="other-news">
  ...
  <?php if (have_posts()) : ?>
    ...
    <p style="padding-bottom: 10px; font-size: 10px; font-style: italic; list-style-type: none;">(Tüm haberleri görmek için <a href="http://linux.org.tr/haberler">tıklayın.</a>)</p>
  <?php endif; ?>
</div>